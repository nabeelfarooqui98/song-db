		...
		<div class="row" style="height:60%;">
			...
			<div class= "col-md-8">
						<div class="card-body">
   						...
   						<label>insert record</label><br>
    					<a href="#" class=" btn btn-primary"><i class="fa fa-edit">&nbsp;</i>add song</a>
    					...
    					<a href="#" class=" btn btn-primary"><i class="fa fa-edit">&nbsp;</i>add user</a>
 						<br><label>update record</label><br>
    					...
    					<a href="#" class=" btn btn-primary"><i class="fa fa-edit">&nbsp;</i>update user</a>
 						<br><label>remove record</label><br>
